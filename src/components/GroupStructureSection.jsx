  ...
  return (
    <section id="هيكل-المجموعة" className="py-24 bg-[#111312] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* ── 2-column grid: left col from LEFT, right col from RIGHT ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">

          {/* Sister companies — from LEFT */}
          <motion.div
            ...
            <div className="flex flex-wrap items-center justify-start gap-10 sm:gap-14">
              {sisterCompanies.map((item, idx) => (
                <motion.div
                  ...
                  transition={{ duration: 0.85, delay: idx * 0.18, ease: EASE }}
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              {distributors.map((item, idx) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0, scale: 1 }}
                  viewport={{ once: false, margin: '-40px' }}
                  transition={{ duration: 0.85, delay: idx * 0.12, ease: EASE }}
